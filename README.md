...
**Community plugins (recommended):** open **Settings → Community plugins**, search **Standing Questions**, and install it — one click, auto-updates.

**Manual install:** copy `main.js`, `manifest.json`, and `styles.css` into `<vault>/.obsidian/plugins/standing-questions/` and enable it in Settings → Community plugins.
...
- **[Report a bug](https://github.com/israerusan/standing-questions/issues/new?labels=bug)** — please include your Obsidian version, your operating system, and the steps that reproduce it.
- **[Request a feature](https://github.com/israerusan/standing-questions/issues/new?labels=enhancement)** — describe the workflow you are trying to make faster; that is more useful than a proposed solution.
- **[Browse open issues](https://github.com/israerusan/standing-questions/issues)** — worth a look first, in case it is already tracked.
